...
| Home Depot.CA MDO — ASN SS1329633 (856, `missing-segment`) + invoice PSI1321830 (810, `price-mismatch`), PO 538506961 / SO1327572 | `claude/home-depot-file-packages-82d92b` | 2026-08-28 | WSH219483 wouldn't post (G/L inconsistency), so the order shipped from the sales order. ASN `_v2`: 15 defects fixed from [`WSH219483-package-capture.md`](WSH219483-package-capture.md) and the 850. Invoice `_v2`: 9 fields fixed — the troubleshooting penny adjustment had put `UnitPrice` 3¢ under the PO, under-billing $0.18 (total 701.17 → 701.35). Both cases logged. Awaiting send to Home Depot and partner confirmation before moving files to Resolved/. |
