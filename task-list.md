...
| Home Care TimbrMart QC invoice PSI1323681 (810) — `tax-missing` (GST + QST both 0.00 on a Quebec ship-to) | `claude/quebec-qst-tax-validation-603f21` | 2026-09-08 | Diagnosed: ship-to 8262 (St-Urbain-de-Charlevoix, QC) invoiced with no GST/QST. Awaiting Sri Hari's calls on freight-in-tax-base and `TermsDiscountAmount` before writing `_v2`. |
