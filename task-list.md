...
| Home Depot.CA MDO ASN SS1329633 (856) — `missing-segment`, PO 538506961 / SO1327572 | `claude/home-depot-file-packages-82d92b` | 2026-08-28 | WSH219483 wouldn't post (G/L inconsistency), so the order shipped from the sales order and the ASN generated with no pack or line data. `_v2` written with all 15 defects corrected from [`WSH219483-package-capture.md`](WSH219483-package-capture.md) and the 850. Case logged. Awaiting send to Home Depot and partner confirmation before moving files to Resolved/. |
