...
| `po-number-format` | PO number (BIG04) doesn't match the format required for the order type (e.g. stock vs. direct-to-customer) |
...
|---|---|---|---|---|---|
| 01 | Orgill US Stores | 810 | `po-number-format` | corrected, awaiting resend | [cases/orgill-us-stores-810.md](cases/orgill-us-stores-810.md#case-01--810--po-number-format--2026-09-11) |
